...
\item The value of $\omega$ is set in the file {\tt parameters.m}. Set $\omega=0$ and run the program. Observe that the energy is decreasing with time.

\item Set $\omega=0.4$ and run the program. Observe that the energy is increasing with time.

...
\item Run {\tt eigtest.m}; first change your matlab directory to the directory {\tt matlab}
\begin{lstlisting}
>> pwd
>> ls
\end{lstlisting}
You should be able to see the {\tt eigtest.m} file in this directory. Now run it
\begin{lstlisting}
>> eigtest
\end{lstlisting}
...
In {\tt eigtest2.m}, replace the function {\tt eig} with {\tt eigs} and compute the 5 smallest eigenvalues

...
struct EulerEquations
{
                             ...
                             Sacado::Fad::DFad<double> (&normal_flux)[n_components])
   {
      ...
      // negative flux
      Sacado::Fad::DFad<double> l1m, l2m, l3m, am, fm;
                             ...
                             Sacado::Fad::DFad<double> (&normal_flux)[n_components])
   {
      ...
      pressure = compute_pressure< Sacado::Fad::DFad<double> > (Wminus);

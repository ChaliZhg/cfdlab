...
\item The value of $\omega$ is set in the file {\tt parameters.m}. Set $\omega=0$ and calculate the eigenvalue with largest real part using {\tt eigs} function. Is this eigenvalue stable or unstable ?
...
\item Set $\omega=0.4$ and caculate the eigenvalue with largest real part using {\tt eigs} function. Compare it with exact eigenvalue given above.

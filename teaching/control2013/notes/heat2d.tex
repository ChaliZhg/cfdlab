...
\caption{Triangular mesh with 100 edges on each side; see the first observation zone  $\{x=0, 0.2 \le y \le 0.25\}$ exactly covered by five boundary edges}
...
\]
which is shown in figure~(\ref{fig:initcond}).
\begin{figure}
\begin{center}
